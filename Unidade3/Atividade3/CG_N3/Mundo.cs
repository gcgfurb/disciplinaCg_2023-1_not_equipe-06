...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      #region Objeto: ponto fora
      var novoPonto = new Ponto(mundo, ref rotuloAtual, new Ponto4D(-0.10, 0.2));
      novoPonto.PrimitivaTamanho = 10;
      novoPonto.Atualizar();
      objetoSelecionado = novoPonto;
      #endregion

      #region Objeto: no ponto G
      var novoPontoG = new Ponto(mundo, ref rotuloAtual, new Ponto4D(0.5, 0.65));
      novoPontoG.PrimitivaTamanho = 10;
      novoPontoG.Atualizar();
      objetoSelecionado = novoPontoG;
      #endregion

      #region Objeto: dentro
      var novoPontoD = new Ponto(mundo, ref rotuloAtual, new Ponto4D(0.5, 0.35));
      novoPontoD.PrimitivaTamanho = 10;
      novoPontoD.Atualizar();
      objetoSelecionado = novoPontoD;
      #endregion
